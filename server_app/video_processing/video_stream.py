...
def process_video_stream(video_stream: cv2.VideoCapture,
                         face_detector_and_emotion_recognizer: FaceAnalysisPipeline | None = None, *,
                         flip_h: bool = False):
    """
    ...
    if use_inner_models:
        ...
        face_detector_and_emotion_recognizer = FaceAnalysisPipeline(face_detector, emotion_recognizer)
